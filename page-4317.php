<?php
/**
 * Template for displaying static page for "Support the Library"  (http://library.wlu.edu/support)
 * 
...
get_header();
?> 
	<div class="content-area support-column" id="wlu-main-column-static">
