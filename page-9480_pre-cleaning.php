	...
	<main id="main" class="site-main" role="main">
		<div id="wlu-discovery-and-links" class="row">
			...
			$today = date("Y-m-d");
            		...
            		// $isWeekday = (date('N') < 6);
            		//echo "<h2>$todayfull</h2>";
			echo ($today < "2020-08-24") ? "<h2>Week of August 17 - 23</h2>" : "<h2>Fall Term Hours</h2>";
             		echo "<table id='lhtable' class='table table-condensed'>";
				echo "<tr><th class='lh-libname' colspan='4'>Leyburn Library <small>(W&amp;L swipe card holders only)</small></th></tr>";
				// echo "<tr><td style='width: 20%'>All Patrons:</td><td colspan='3'>Closed</td></tr>";
				if ($today < "2020-08-24") {
					echo "<tr><td style='width: 20%; text-indent: 1em;'>Mon - Fri:</td><td>8:00am</td><td>&mdash;</td><td>8:00pm</td></tr>";
					echo "<tr><td style='width: 20%; text-indent: 1em;'>Sat - Sun:</td><td>Noon</td><td>&mdash;</td><td>8:00pm</td></tr>";
				} else {
					echo "<tr><td style='width: 20%; text-indent: 1em;'>Mon - Thu:</td><td>7:00am</td><td>&mdash;</td><td>2:00am</td></tr>";
					echo "<tr><td style='width: 20%; text-indent: 1em;'>Fri:</td><td>7:00am</td><td>&mdash;</td><td>Midnight</td></tr>";
					echo "<tr><td style='width: 20%; text-indent: 1em;'>Sat:</td><td>Noon</td><td>&mdash;</td><td>Midnight</td></tr>";
					if ($today > "2020-10-25") {
						echo "<tr><td style='width: 20%; text-indent: 1em;'>Sun:</td><td>9:00am</td><td>&mdash;</td><td>2:00am</td></tr>";
					} else {
						echo "<tr><td style='width: 20%; text-indent: 1em;'>Sun:</td><td>Noon</td><td>&mdash;</td><td>2:00am</td></tr>";
					}
				}	
				echo "<tr><th class='lh-libname' colspan='4'>Telford Science Library <small>(W&amp;L swipe card holders only)</small></th></tr>";
				echo "<tr><td style='width: 20%; text-indent: 1em;'>Mon - Sun:</td><td colspan='3'>Open 24/7</td></tr>";
            			// echo "<tr class='covid-rhc-head'><td colspan='4'><h4>Research Help Chat Schedule <small>(all times Eastern)</small></h4>";
				// echo ($today == "2020-07-03") ? "<h5><em>Schedule resumes Monday, June 6</h5>" : "";
				// echo "</td></tr>";
				// echo "<tr class='covid-rhc-row covid-rhc-dark'><td style='width: 20%; text-indent: 1em;'>Sun</td><td>8:00pm<td>&mdash;</td><td>10:00pm</td></tr>";
            			// echo "<tr class='covid-rhc-row covid-rhc-dark'><td style='width: 20%; text-indent: 1em;'>Mon - Wed:</td><td>11:00am</td><td>&mdash;</td><td>10:00pm</td></tr>";
            			// echo "<tr class='covid-rhc-row covid-rhc-dark'><td style='width: 20%; text-indent: 1em;'>Thu</td><td>10:30am</td><td>&mdash;</td><td>10:00pm</td></tr>";
            			// echo "<tr class='covid-rhc-row covid-rhc-dark'><td style='width: 20%; text-indent: 1em;'>Fri</td><td>9:00am</td><td>&mdash;</td><td>5:30pm</td></tr>";
            		echo "</table>";
			echo "</div>";
            ?>
		    </div>
