	...
	<main id="main" class="site-main" role="main">
		<div id="wlu-discovery-and-links" class="row">
			<div class="col-xs-12 col-md-12 col-lg-10 col-xl-8 col-md-offset-0 col-lg-offset-1 col-xl-offset-2 discovery-search" id="discovery-search">
				<span class="discovery-title">Search Everything</span> <i id="discovery-info-icon" class="wlutip fa fa-info-circle" data-toggle="tooltip" data-trigger="click hover focus" data-placement="bottom" title="Almost!  Search Everything allows you to search all of the University Library's collections from books to journal articles to DVDs and so much more."></i>
				<span class="discovery-separator">|</span>
				<span class="summon-advanced-search"><a target="_blank" href="https://wlu.primo.exlibrisgroup.com/discovery/search?vid=01WLU_INST:01WLU&sortby=rank&mode=advanced&lang=en">Advanced Search</a></span>
				<span class="discovery-separator">|</span>
				<span class="summon-advanced-search"><a href="https://wlu.primo.exlibrisgroup.com/discovery/login?vid=01WLU_INST:01WLU&lang=en">My Library Account</a></span>
