<?php
/**
 * Template for displaying static page for "Research Help"  (http://library.wlu.edu/research-help)
 * 
...
get_header();
?> 
	<div class="content-area research-help portal-page" id="wlu-main-column-static">
